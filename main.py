...
class NewProjectWindow(wx.Frame):
    def __init__(self, parent, title):
        ...
        self.choice_1 = self.create_choice(grid_sizer, ["Struck Pedestrian", "Collision With Vehicle", "Collision with fixed object",
                                                        "No Collision and no object struck","Struck Animals", "Vehicle overturned(No Collision)",
                                                        "Collision with some other object", "Fall from or in moving vehicle", "Other Accident"])
        self.create_empty_cell(grid_sizer)
